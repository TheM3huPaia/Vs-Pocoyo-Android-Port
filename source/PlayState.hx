...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['KKKK!', 0.2], //From 0% to 19%
		['Velho', 0.4], //From 20% to 39%
		['Ruim', 0.5], //From 40% to 49%
		['Ata', 0.6], //From 50% to 59%
		['Nahh', 0.69], //From 60% to 68%
		['Legal', 0.7], //69%
		['Bom', 0.8], //From 70% to 79%
		['Que cu', 0.9], //From 80% to 89%
		['Foda!', 1], //From 90% to 99%
		['VLK Mods??', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	public function updateScore(miss:Bool = false)
	{
		...
		+ ' | Ported by Karl | Missed: ' + songMisses
		+ ' | Rating: ' + ratingName
